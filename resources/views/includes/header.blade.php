                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        ...
                                                                        <li><a target="_blank" href="#">Sport Wear</a>
                                                                        </li>
                                                                        <li><a target="_blank" href="#">Ethic Wear</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a target="_blank" href="#">Watches </a>
                                                                        </li>
                                                                        <li><a target="_blank" href="#">Hats </a></li>
                                                                        <li><a target="_blank" href="#">Necklaces </a>
                                                                        </li>
                                                                        <li><a target="_blank" href="#">Earrings </a>
                                                                        </li>
                                                                        <li><a target="_blank" href="#">Wrist Wear</a>
                                                                        </li>
                                ...
                                <ul>
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            <li>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h4><span>1 x &pound; 299.00</span></h4>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="total">
                                                    <h5>subtotal : <span>&pound;299.00</span></h5>
                                                </div>
                                            </li>
                                            <li>
