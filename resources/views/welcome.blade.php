            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="product-para">
                    <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                        tempor
                        incididunt ut labore et dolore magna aliqua. Tellus cras adipiscing enim eu.</p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="cart-info cart-wrap">
                                    ...
                                    <a href="javascript:void(0)"
                                       title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a
                                        ...
                                        href="#" title="Compare"><i class="ti-reload"
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current"><a href="tab-4">Lorem Ipsum</a></li>
                            <li class=""><a href="tab-5">Lorem Ipsum</a></li>
                            <li class=""><a href="tab-6">Lorem Ipsum</a></li>
                        </ul>
