                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <li><a href="#">pages</a>
                                            <ul>
                                                ...
                                                <li><a href="search.blade.php">search</a></li>
                                                <li><a href="review.blade.php">review</a>
                                                </li>
                                                <li>
                                                    <a href="#">compare</a>
                                                    <ul>
                                ...
                                <div class="top-banner-wrapper">
                                    ...
                                    <div class="top-banner-content small-section">
                                        ...
                                        <p>The trick to choosing the best wear for yourself is to keep in mind your body
                                            ...
                                            30-day return and exchange policy, free and fast shipping across all pin
                                            codes, cash or card on delivery option, deals and discounts, among other
                                            perks. So, sign up now and shop for westarn wear to your heart’s content on
                                            Multikart. </p>
                                    </div>
                                </div>
                                <div class="collection-product-wrapper">
                                            ...
                                            <div class="col-12">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-detail">
                                                        ...
                                                        <a href="product-page(no-sidebar).html">
                                                            <h6>Multi Color polo T-shirt</h6>
                                                        </a>
                                                        <p>Lorem Ipsum is simply dummy text of the printing and
                                                            typesetting industry. Lorem Ipsum has been the
                                                            industry's standard dummy text ever since the 1500s,
